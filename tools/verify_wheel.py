...
REQUIRED_PATHS = {
    ...
    "powerd/cli.py",
    "powerd/daemon.py",
    "powerd/inhibitors.py",
    "powerd/policy.py",
    "powerd/runtime.py",
    "powerd/wake.py",
    "open_mmi_telemetry/__init__.py",
    "open_mmi_telemetry/cli.py",
    "open_mmi_telemetry/guard.py",
    "open_mmi_trust/__init__.py",
    ...
    "open_mmi_trust/data/trust-transition-lineage-record.v1.schema.json",
    "open_mmi_trust/data/installed-release-integrity.v1.schema.json",
    "open_mmi_trust/data/release-signer-root.v1.schema.json",

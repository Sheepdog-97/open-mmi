(function (root, factory) {
  ...
  function statusSummary(result, settings = {}) {
    ...
    return { label: "Trip B", detail: formatDistanceWithUnit(result.tripKm, settings) };
  }
  ...
  function install(options = {}) {
    ...
    function renderPanel() {
      ...
      host.innerHTML = `
        <div class="openmmi-settings-panel-head"><span>Trip B</span><small>long-term odometer-based trip counter</small></div>
  ...
  return Object.freeze({ ENDPOINT, RESET_ENDPOINT, KM_PER_MILE, evaluate, distanceForDisplay, formatDistance, formatDistanceWithUnit, statusSummary, install });
});
